...
public class CustomizePathsTraverser extends HugeTraverser {
    ...
    public static List<Path> topNPath(List<Path> paths,
        ...
        paths.sort(((p1, p2) -> {
            CustomizePathsTraverser.WeightPath wp1 = (CustomizePathsTraverser.WeightPath) p1;
            CustomizePathsTraverser.WeightPath wp2 = (CustomizePathsTraverser.WeightPath) p2;
            int result;
